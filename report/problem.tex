...
To summarize, we make the following contributions:
	...
	\squish
		...
		\item {\em Soundness of metrics.} We verify if our metrics are sound to measure the innovation impact of an organization. Specifically, we compare our ranking results to public lists such as Forbes and Reuters~\cite{forbes, top100}.
	\end{itemize}